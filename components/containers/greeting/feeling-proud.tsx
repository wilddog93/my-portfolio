...
export const FeelingProud:FC<Props> = ({ ...props }) => {
  ...
  return (
    ...
    >
      ...
      <g id="head">
        ...
        <g id="eyey2">
          <circle id="circle113" r="5" cy="114" cx="98.4" fill={colors.dark} />
          <circle id="circle115" r="5" cy="114" cx="136.9" fill={colors.dark} />
        </g>
      </g>
      <g id="shirt">
        <path
